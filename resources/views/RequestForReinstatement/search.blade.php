                                    ...
                                    <div class="col-sm-3">
                                        <div class="container pl-0">
                                            <div class="row">
                                                ...
                                                <a type="button" class="btn btn-secondary btn-md"  href='{{ route("RequestForReinstatement") }}'>
                ...
                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class= "btn btn-info  btn-md" href="{{url('/RequestForReinstatement/'.$data->Codigo_reposicion.'/show')}}">
                                    <span class="icon text-white-60">
