...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Solicitudes De Reposición</h1>
        
        <a href="{{url('/RequestForReinstatement/create')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="m-0 text-left row">
                <div class="col p-0 ">
                    <h6 class="m-0 pt-2 font-weight-bold text-primary">Lista de Solicitudes de Reposición</h6>
                </div>
                <div class="d-sm-flex">
                    ...
                    <i class="fa fa-eye text-white-70"></i> Mostrar Deshabilitados </a>
                </div>
            </div>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered text-center" id="" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class= "btn btn-info  btn-md" href="{{url('RequestForReinstatement/'.$data->Codigo_reposicion.'/showRequirement')}}">
                                    <span class="icon text-white-60">
                                    <i class="fa fa-eye" aria-hidden="true"></i></span>
                                </a>
                                <a class="btn btn-success  btn-md" href="{{url('/RequestForReinstatement/'.$data->Codigo_reposicion.'/edit')}}">
                                    <span class="icon text-white-60">
    ...
    function deleteConfirmation(id, date) {
        Swal.fire({
            ...
            if (e.value === true) {
                ...
                var url = "{{ route('RequestForReinstatement.delete',[':id']) }}";
                ...
                $.ajax({
                    ...
                    success: function (results) {
                        if (results.status == 1) {
                            ...
                            Toast.fire({
                                icon: 'error',
                                html: 'Ocurrio un error al intentar eliminar la solicitud: <strong>'+id+' ('+date+')</strong>',
                            });
                        }
                    }
                });
